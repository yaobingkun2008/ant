...
typedef TMilli antC$RetxmitTimer$precision_tag;
typedef control_queue_entry_t *antC$SendQueue$t;
typedef TMilli antC$Timer1$precision_tag;
typedef control_queue_receive_t *antC$ReceiveQueue$t;
typedef TMilli antC$MilliTimer$precision_tag;
typedef TMilli antC$TimerDebug$precision_tag;
...
typedef control_queue_entry_t */*antAppC.SendQueueP*/QueueC$0$queue_t;
typedef /*antAppC.SendQueueP*/QueueC$0$queue_t /*antAppC.SendQueueP*/QueueC$0$Queue$t;
typedef control_queue_receive_t */*antAppC.ReceiveQueueP*/QueueC$1$queue_t;
typedef /*antAppC.ReceiveQueueP*/QueueC$1$queue_t /*antAppC.ReceiveQueueP*/QueueC$1$Queue$t;
...
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static error_t /*antAppC.SendControl.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
static void /*antAppC.SendControl.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(
#line 96
message_t * msg, 
...
static void antC$AMControl$startDone(error_t error);
#line 138
static void antC$AMControl$stopDone(error_t error);
# 60 "/opt/tinyos-2.1.2/tos/interfaces/Boot.nc"
static void antC$Boot$booted(void );
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void antC$RetxmitTimer$fired(void );
#line 83
static void antC$Timer1$fired(void );
# 75 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
static void antC$senddatatask$runTask(void );
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static void antC$BeaconSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void antC$MilliTimer$fired(void );
#line 83
static void antC$TimerDebug$fired(void );
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
static 
#line 74
message_t * 
...
uint8_t len);
# 75 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
static void antC$Receivedatatask$runTask(void );
...
static 
#line 71
/*antAppC.SendQueueP*/QueueC$0$Queue$t  

/*antAppC.SendQueueP*/QueueC$0$Queue$head(void );
#line 90
static error_t /*antAppC.SendQueueP*/QueueC$0$Queue$enqueue(
#line 86
/*antAppC.SendQueueP*/QueueC$0$Queue$t  newVal);
#line 65
static uint8_t /*antAppC.SendQueueP*/QueueC$0$Queue$maxSize(void );
#line 81
static 
#line 79
/*antAppC.SendQueueP*/QueueC$0$Queue$t  

/*antAppC.SendQueueP*/QueueC$0$Queue$dequeue(void );
#line 50
static bool /*antAppC.SendQueueP*/QueueC$0$Queue$empty(void );
...
static uint8_t /*antAppC.SendQueueP*/QueueC$0$Queue$size(void );
#line 73
static 
#line 71
/*antAppC.ReceiveQueueP*/QueueC$1$Queue$t  

/*antAppC.ReceiveQueueP*/QueueC$1$Queue$head(void );
#line 90
static error_t /*antAppC.ReceiveQueueP*/QueueC$1$Queue$enqueue(
#line 86
/*antAppC.ReceiveQueueP*/QueueC$1$Queue$t  newVal);
#line 65
static uint8_t /*antAppC.ReceiveQueueP*/QueueC$1$Queue$maxSize(void );
#line 81
static 
#line 79
/*antAppC.ReceiveQueueP*/QueueC$1$Queue$t  

/*antAppC.ReceiveQueueP*/QueueC$1$Queue$dequeue(void );
#line 50
static bool /*antAppC.ReceiveQueueP*/QueueC$1$Queue$empty(void );
...
static uint8_t /*antAppC.ReceiveQueueP*/QueueC$1$Queue$size(void );
...
void sim_mote_enqueue_boot_event(int mote)   ;
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static void /*antAppC.SendControl.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
static error_t /*antAppC.SendControl.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(
#line 67
message_t * msg, 
...
static void /*antAppC.SendControl.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*antAppC.SendControl.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(
#line 158
message_t * amsg, 
...
static error_t /*antAppC.SendControl.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*antAppC.SendControl.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(message_t *m, error_t err);
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
...
# 104 "/opt/tinyos-2.1.2/tos/interfaces/SplitControl.nc"
static error_t antC$AMControl$start(void );
...
uint8_t len);
# 73 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void antC$RetxmitTimer$startOneShot(uint32_t dt);
# 52 "/opt/tinyos-2.1.2/tos/interfaces/Random.nc"
static uint16_t antC$Random$rand16(void );
# 73 "/opt/tinyos-2.1.2/tos/interfaces/Queue.nc"
static 
#line 71
antC$SendQueue$t  

antC$SendQueue$head(void );
#line 90
static error_t antC$SendQueue$enqueue(
#line 86
antC$SendQueue$t  newVal);
#line 81
static 
#line 79
antC$SendQueue$t  

antC$SendQueue$dequeue(void );
# 73 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void antC$Timer1$startOneShot(uint32_t dt);
# 67 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
static error_t antC$senddatatask$postTask(void );
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static error_t antC$BeaconSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
antC$ReceiveQueue$head(void );
#line 90
static error_t antC$ReceiveQueue$enqueue(
#line 86
antC$ReceiveQueue$t  newVal);
#line 81
static 
#line 79
antC$ReceiveQueue$t  

antC$ReceiveQueue$dequeue(void );
# 73 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void antC$MilliTimer$startOneShot(uint32_t dt);
# 88 "/opt/tinyos-2.1.2/tos/interfaces/AMPacket.nc"
static am_addr_t antC$AMPacket$source(
#line 84
message_t * amsg);
# 67 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
...
uint8_t antC$tableactive[1000];
uint16_t antC$battery[1000];
bool antC$isrunning[1000];
bool antC$busy[1000];
message_t antC$pkt[1000];
message_t antC$pkt2[1000];
message_t antC$pkt3[1000];
uint8_t antC$hellonum[1000];

uint8_t antC$forward_num[1000];
uint8_t antC$backward_num[1000];
uint8_t antC$post_fail[1000];
uint8_t antC$flag[1000];
uint8_t antC$receiveantnum[1000];
uint8_t antC$sendnum[1000];
uint8_t antC$testnum[1000];
uint8_t antC$battery_level[1000];

bool antC$receiving[1000];
static inline bool antC$is_destable(void );
#line 60
static inline void antC$Boot$booted(void );
...
/*antAppC.SendQueueP*/QueueC$0$queue_t  /*antAppC.SendQueueP*/QueueC$0$queue[1000][20];
uint8_t /*antAppC.SendQueueP*/QueueC$0$head[1000];
uint8_t /*antAppC.SendQueueP*/QueueC$0$tail[1000];
uint8_t /*antAppC.SendQueueP*/QueueC$0$size[1000];

static inline bool /*antAppC.SendQueueP*/QueueC$0$Queue$empty(void );



static inline uint8_t /*antAppC.SendQueueP*/QueueC$0$Queue$size(void );



static inline uint8_t /*antAppC.SendQueueP*/QueueC$0$Queue$maxSize(void );



static inline /*antAppC.SendQueueP*/QueueC$0$queue_t /*antAppC.SendQueueP*/QueueC$0$Queue$head(void );



static void /*antAppC.SendQueueP*/QueueC$0$printQueue(void );
#line 85
static /*antAppC.SendQueueP*/QueueC$0$queue_t /*antAppC.SendQueueP*/QueueC$0$Queue$dequeue(void );
#line 97
static error_t /*antAppC.SendQueueP*/QueueC$0$Queue$enqueue(/*antAppC.SendQueueP*/QueueC$0$queue_t newVal);
#line 48
/*antAppC.ReceiveQueueP*/QueueC$1$queue_t  /*antAppC.ReceiveQueueP*/QueueC$1$queue[1000][20];
uint8_t /*antAppC.ReceiveQueueP*/QueueC$1$head[1000];
uint8_t /*antAppC.ReceiveQueueP*/QueueC$1$tail[1000];
uint8_t /*antAppC.ReceiveQueueP*/QueueC$1$size[1000];

static inline bool /*antAppC.ReceiveQueueP*/QueueC$1$Queue$empty(void );



static inline uint8_t /*antAppC.ReceiveQueueP*/QueueC$1$Queue$size(void );



static inline uint8_t /*antAppC.ReceiveQueueP*/QueueC$1$Queue$maxSize(void );



static inline /*antAppC.ReceiveQueueP*/QueueC$1$queue_t /*antAppC.ReceiveQueueP*/QueueC$1$Queue$head(void );



static void /*antAppC.ReceiveQueueP*/QueueC$1$printQueue(void );
#line 85
static /*antAppC.ReceiveQueueP*/QueueC$1$queue_t /*antAppC.ReceiveQueueP*/QueueC$1$Queue$dequeue(void );
#line 97
static inline error_t /*antAppC.ReceiveQueueP*/QueueC$1$Queue$enqueue(/*antAppC.ReceiveQueueP*/QueueC$1$queue_t newVal);
...
#line 67
  SerialActiveMessageC$startDone = 9U
};
#line 67
typedef int SerialActiveMessageC$__nesc_sillytask_startDone[SerialActiveMessageC$startDone];
enum SerialActiveMessageC$__nesc_unnamed4350 {
#line 68
  SerialActiveMessageC$stopDone = 10U
};
#line 68
...
#line 238
  sim_log_debug(50U, "Packet", "Delivering packet to %i at %s\n", (int )sim_node(), sim_time_string());
...
# 67 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
inline static error_t antC$Receivedatatask$postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP$TaskBasic$postTask(antC$Receivedatatask);
#line 67
...
#line 57
{
  return /*antAppC.ReceiveQueueP*/QueueC$1$size[sim_node()];
}
...
#line 97
{
  if (/*antAppC.ReceiveQueueP*/QueueC$1$Queue$size() < /*antAppC.ReceiveQueueP*/QueueC$1$Queue$maxSize()) {
      sim_log_debug(232U, "QueueC", "%s: size is %hhu\n", __FUNCTION__, /*antAppC.ReceiveQueueP*/QueueC$1$size[sim_node()]);
      /*antAppC.ReceiveQueueP*/QueueC$1$queue[sim_node()][/*antAppC.ReceiveQueueP*/QueueC$1$tail[sim_node()]] = newVal;
      /*antAppC.ReceiveQueueP*/QueueC$1$tail[sim_node()]++;
      if (/*antAppC.ReceiveQueueP*/QueueC$1$tail[sim_node()] == 20) {
#line 102
        /*antAppC.ReceiveQueueP*/QueueC$1$tail[sim_node()] = 0;
        }
#line 103
      /*antAppC.ReceiveQueueP*/QueueC$1$size[sim_node()]++;
      /*antAppC.ReceiveQueueP*/QueueC$1$printQueue();
      return SUCCESS;
    }
  else {
      return FAIL;
...
inline static error_t antC$ReceiveQueue$enqueue(antC$ReceiveQueue$t  newVal){
#line 90
  unsigned char __nesc_result;
#line 90

#line 90
  __nesc_result = /*antAppC.ReceiveQueueP*/QueueC$1$Queue$enqueue(newVal);
#line 90
      ...
      if (antC$ReceiveQueue$enqueue(new_packet) == SUCCESS) 
        {
          if (antC$Receivedatatask$postTask() != SUCCESS) 
            {
              sim_log_debug(190U, "Test1", "gg!\n");
            }
        }
      else 
        {
          sim_log_debug(191U, "Test1", "shit!");
        }
...
#line 78
    case 6:
#line 78
      __nesc_result = antC$BeaconReceive$receive(msg, payload, len);
#line 78
      break;
#line 78
    default:
...
#line 57
{
  return /*antAppC.SendQueueP*/QueueC$0$size[sim_node()];
}
...
# 104 "/opt/tinyos-2.1.2/tos/interfaces/SplitControl.nc"
inline static error_t antC$AMControl$start(void ){
#line 104
  unsigned char __nesc_result;
#line 104
...
#line 104
# 73 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void antC$MilliTimer$startOneShot(uint32_t dt){
#line 73
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$startOneShot(2U, dt);
#line 73
}
#line 73
inline static void antC$Timer1$startOneShot(uint32_t dt){
#line 73
...
{
  if (err == SUCCESS) {
      antC$post_fail[sim_node()] = 0;
      antC$battery_level[sim_node()] = 10;
      antC$tableactive[sim_node()] = 0;
      antC$battery[sim_node()] = 10000;
      antC$isrunning[sim_node()] = TRUE;
      antC$hellonum[sim_node()] = 0;
      antC$forward_num[sim_node()] = -1;
      antC$receiveantnum[sim_node()] = -1;
      antC$sendnum[sim_node()] = -1;
      ...
      antC$MilliTimer$startOneShot(100);
    }
  else {
      antC$AMControl$start();
    }
}
...
#line 113
  antC$AMControl$startDone(error);
#line 113
}
#line 113
# 96 "/opt/tinyos-2.1.2/tos/lib/tossim/TossimPacketModelC.nc"
...
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static void /*antAppC.SendControl.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(message_t * msg, error_t error){
#line 110
  antC$BeaconSend$sendDone(msg, error);
#line 110
}
#line 110
...
#line 65
{
  /*antAppC.SendControl.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(m, err);
}
...
#line 100
    case 0U:
#line 100
      /*antAppC.SendControl.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    default:
...
# 67 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
inline static error_t antC$senddatatask$postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP$TaskBasic$postTask(antC$senddatatask);
#line 67
...
#line 67
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t antC$BeaconSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*antAppC.SendControl.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(addr, msg, len);
#line 80
...
# 126 "/opt/tinyos-2.1.2/tos/interfaces/Packet.nc"
inline static void * antC$Packet$getPayload(message_t * msg, uint8_t len){
#line 126
  void *__nesc_result;
#line 126
...
inline static antC$SendQueue$t  antC$SendQueue$dequeue(void ){
#line 81
  struct __nesc_unnamed4288 *__nesc_result;
#line 81

#line 81
  __nesc_result = /*antAppC.SendQueueP*/QueueC$0$Queue$dequeue();
#line 81
...
# 52 "/opt/tinyos-2.1.2/tos/interfaces/Random.nc"
inline static uint16_t antC$Random$rand16(void ){
#line 52
  unsigned short __nesc_result;
#line 52
  ...
  for (k = 0; k < antC$tableactive[sim_node()]; k++) 
    {
      if (antC$routing_table[sim_node()][k].enabled == TRUE) 
        {
          if (antC$routing_table[sim_node()][k].dest == destin) 
            {
              if (antC$findin(ttl, visited, antC$routing_table[sim_node()][k].neighbor) == FALSE) 
                {
...
#line 262
                  if (c > bignum) 
                    {
                      g = 1;
                      select[0] = antC$routing_table[sim_node()][k].neighbor;
                      bignum = c;
                    }
                  else {
#line 268
                    if (bignum == c) 
                      {
                        g++;
                        select[g - 1] = antC$routing_table[sim_node()][k].neighbor;
                        bignum = c;
                      }
                    }
                }
...
#line 49
  for (i = 0; i < antC$tableactive[sim_node()]; i++) 
    {
      if (antC$routing_table[sim_node()][i].neighbor == DEST_NODE && antC$routing_table[sim_node()][i].enabled == TRUE) 
        {
          return 1;
        }
    }
...
#line 65
{
  return /*antAppC.SendQueueP*/QueueC$0$queue[sim_node()][/*antAppC.SendQueueP*/QueueC$0$head[sim_node()]];
}

# 73 "/opt/tinyos-2.1.2/tos/interfaces/Queue.nc"
inline static antC$SendQueue$t  antC$SendQueue$head(void ){
#line 73
  struct __nesc_unnamed4288 *__nesc_result;
#line 73

#line 73
  __nesc_result = /*antAppC.SendQueueP*/QueueC$0$Queue$head();
#line 73
...
#line 73
# 73 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void antC$RetxmitTimer$startOneShot(uint32_t dt){
#line 73
          ...
          if (pac_send->classify == 1) 
            {
              ...
              btrpkt = (energymessage_t *)antC$Packet$getPayload(&antC$pkt[sim_node()], (void *)0);
              ...
              if (antC$BeaconSend$send(AM_BROADCAST_ADDR, &antC$pkt[sim_node()], sizeof(energymessage_t )) == SUCCESS) 
                {

                  antC$flag[sim_node()] = 1;
            ...
            if (pac_send->classify == 2) 
              {
                ...
                btrpkt2 = (forwardant_t *)antC$Packet$getPayload(&antC$pkt2[sim_node()], (void *)0);
                ...
                if (antC$is_destable() == 1) 
                  {
                    ...
                    if (antC$BeaconSend$send(DEST_NODE, &antC$pkt2[sim_node()], sizeof(forwardant_t )) == SUCCESS) 
                      {
                        if (TOS_NODE_ID == 0) 
                          {
                          }
                  ...
                  {
                    uint16_t nexthop = antC$find_next_hop(__nesc_ntoh_uint8(btrpkt2->ttl.nxdata), btrpkt2->visit, __nesc_ntoh_uint16(btrpkt2->dest.nxdata));
                    ...
                    if (nexthop == 99) 
                    ...
                    else 
                      {
                        ...
                        if (antC$BeaconSend$send(nexthop, &antC$pkt2[sim_node()], sizeof(forwardant_t )) == SUCCESS) 
                          {
              ...
              if (pac_send->classify == 3) 
                {
                  ...
                  if (antC$BeaconSend$send(nexthop, &antC$pkt3[sim_node()], sizeof(backwardant_t )) == SUCCESS) 
                    {
                      antC$flag[sim_node()] = 3;
                      antC$busy[sim_node()] = TRUE;
                    }
                  else 
                    {
...
# 81 "/opt/tinyos-2.1.2/tos/interfaces/Queue.nc"
inline static antC$ReceiveQueue$t  antC$ReceiveQueue$dequeue(void ){
#line 81
  struct __nesc_unnamed4289 *__nesc_result;
#line 81

#line 81
  __nesc_result = /*antAppC.ReceiveQueueP*/QueueC$1$Queue$dequeue();
#line 81
...
inline static error_t antC$SendQueue$enqueue(antC$SendQueue$t  newVal){
#line 90
  unsigned char __nesc_result;
#line 90

#line 90
  __nesc_result = /*antAppC.SendQueueP*/QueueC$0$Queue$enqueue(newVal);
#line 90
...
#line 65
{
  return /*antAppC.ReceiveQueueP*/QueueC$1$queue[sim_node()][/*antAppC.ReceiveQueueP*/QueueC$1$head[sim_node()]];
}

# 73 "/opt/tinyos-2.1.2/tos/interfaces/Queue.nc"
inline static antC$ReceiveQueue$t  antC$ReceiveQueue$head(void ){
#line 73
  struct __nesc_unnamed4289 *__nesc_result;
#line 73

#line 73
  __nesc_result = /*antAppC.ReceiveQueueP*/QueueC$1$Queue$head();
#line 73
...
#line 551
          if (idx < antC$tableactive[sim_node()]) {
              antC$routing_table[sim_node()][idx].energy = __nesc_ntoh_uint8(a->energy.nxdata);
              if (antC$routing_table[sim_node()][idx].enabled == TRUE && antC$routing_table[sim_node()][idx].energy == 2) 
                {
                  antC$routing_table[sim_node()][idx].enabled = FALSE;
                  antC$routing_table[sim_node()][idx].phero = 0;
                }
              else {
#line 558
...
#line 584
            ...
            else 
              {
                ...
                if (antC$SendQueue$enqueue(new_forward) == SUCCESS) 
                  {
                    if (antC$senddatatask$postTask() != SUCCESS) 
                      {
...
#line 75
      break;
#line 75
    case antC$senddatatask:
#line 75
      antC$senddatatask$runTask();
#line 75
      break;
#line 75
    case antC$Receivedatatask:
#line 75
      antC$Receivedatatask$runTask();
#line 75
      break;
#line 75
...
static inline void antC$Timer1$fired(void )
{
  ...
  if (antC$receiving[sim_node()] == FALSE) 
    {
      control_queue_entry_t *new_forward = (void *)0;
      ...
      if (TOS_NODE_ID != DEST_NODE) 
        {
          ...
          __nesc_hton_uint8(new_forward->f_message->seqno.nxdata, antC$forward_num[sim_node()]);
...
#line 83
    case 0U:
#line 83
      antC$TimerDebug$fired();
#line 83
      break;
#line 83
    case 1U:
#line 83
      antC$RetxmitTimer$fired();
#line 83
      break;
#line 83
    case 2U:
#line 83
      antC$MilliTimer$fired();
#line 83
      break;
#line 83
    case 3U:
...
#line 53
{
  return /*antAppC.ReceiveQueueP*/QueueC$1$size[sim_node()] == 0;
}
...
# 103 "/opt/tinyos-2.1.2/tos/interfaces/AMPacket.nc"
inline static void /*antAppC.SendControl.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 103
...
inline static void /*antAppC.SendControl.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(message_t * amsg, am_id_t t){
#line 162
...
# 75 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
inline static error_t /*antAppC.SendControl.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
#line 296
{
  ...
  sim_log_debug(70U, "CpmModelC", "Handling reception event @ %s.\n", sim_time_string());
  while (list != (void *)0) {
      if (list->next == mine) {
          predecessor = list;
        }
...
#line 311
    if (mine == CpmModelC$outstandingReceptionHead[sim_node()]) {
        ...
        sim_log_error(71U, "CpmModelC", "Incoming packet list structure is corrupted: entry is not the head and no entry points to it.\n");
      }
    }
#line 317
  sim_log_debug(72U, "CpmModelC,SNRLoss", "Packet from %i to %i\n", (int )mine->source, (int )sim_node());
  if (!CpmModelC$checkReceive(mine)) {
      sim_log_debug(73U, "CpmModelC,SNRLoss", " - lost packet from %i as SNR was too low.\n", (int )mine->source);
      mine->lost = 1;
    }
  if (! mine->lost) {
...
#line 327
      ...
      sim_log_debug_clear(74U, "CpmModelC,SNRLoss", "  -signaling reception\n");
      CpmModelC$Model$receive(mine->msg);
      if (mine->ack) {
          sim_log_debug_clear(75U, "CpmModelC", " acknowledgment requested, ");
        }
      else {
          sim_log_debug_clear(76U, "CpmModelC", " no acknowledgment requested.\n");
        }

      if (mine->ack && CpmModelC$Model$shouldAck(mine->msg)) {
          sim_log_debug_clear(77U, "CpmModelC", " scheduling ack.\n");
      ...
      if (RandomUniform() < 0.001) {
          sim_log_debug(78U, "CpmModelC,SNRLoss", "Packet was technically lost, but TOSSIM introduces an ack false positive rate.\n");
          if (mine->ack && CpmModelC$Model$shouldAck(mine->msg)) {
              sim_log_debug_clear(79U, "CpmModelC", " scheduling ack.\n");
              CpmModelC$sim_gain_schedule_ack(mine->source, sim_time() + 1, mine);
            }
          else {
              CpmModelC$free_receive_message(mine);
      ...
      CpmModelC$receiving[sim_node()] = 0;
      sim_log_debug_clear(80U, "CpmModelC,SNRLoss", "  -packet was lost.\n");
    }
}
...
#line 374
  ...
  if (!sim_mote_is_on(sim_node())) {
      sim_log_debug(81U, "CpmModelC", "Lost packet from %i due to %i being off\n", source, sim_node());
      rcv->lost = 1;
    }
  else {
#line 396
    if (!CpmModelC$shouldReceive(power - noiseStr)) {
        sim_log_debug(82U, "CpmModelC,SNRLoss", "Lost packet from %i to %i due to SNR being too low (%i)\n", source, sim_node(), (int )(power - noiseStr));
        rcv->lost = 1;
      }
    else {
#line 400
      if (CpmModelC$receiving[sim_node()]) {
          sim_log_debug(83U, "CpmModelC,SNRLoss", "Lost packet from %i due to %i being mid-reception\n", source, sim_node());
          rcv->lost = 1;
        }
      else {
#line 404
        if (CpmModelC$transmitting[sim_node()] && rcv->start < CpmModelC$transmissionEndTime[sim_node()] && CpmModelC$transmissionEndTime[sim_node()] <= rcv->end) {
            sim_log_debug(84U, "CpmModelC,SNRLoss", "Lost packet from %i due to %i being mid-transmission, transmissionEndTime %llu\n", source, sim_node(), CpmModelC$transmissionEndTime[sim_node()]);
            rcv->lost = 1;
          }
        else {
...
#line 412
  ...
  while (list != (void *)0) {
      if (!CpmModelC$shouldReceive(list->power - rcv->power)) {
          sim_log_debug(85U, "Gain,SNRLoss", "Going to lose packet from %i with signal %lf as am receiving a packet from %i with signal %lf\n", list->source, list->power, source, rcv->power);
          list->lost = 1;
        }
      list = list->next;
    }
...
#line 430
  sim_log_debug(86U, "CpmModelC", "Enqueing reception event for %i at %llu with power %lf.\n", dest, endTime, power);
  sim_set_node(dest);
...
#line 439
  ...
  sim_log_debug(87U, "CpmModelC", "Node %i transmitting to %i, finishes at %llu.\n", sim_node(), dest, endTime);
...
#line 446
  ...
  while (list != (void *)0) {
      list->lost = 1;
      sim_log_debug(88U, "CpmModelC,SNRLoss", "Lost packet from %i because %i has outstanding reception, startTime %llu endTime %llu\n", list->source, sim_node(), list->start, list->end);
      list = list->next;
    }
}
...
#line 282
  ...
  sim_log_debug(62U, "TossimPacketModelC", "PACKET: Signaling send done at %llu.\n", sim_time());
...
#line 253
{
  ...
  sim_log_debug(60U, "TossimPacketModelC", "PACKET: Broadcasting packet to everyone.\n");
  ...
  sim_log_debug(61U, "TossimPacketModelC", "PACKET: Send done at %llu.\n", evt->time);
...
#line 459
{
  ...
  sim_log_debug(89U, "CpmModelC", "setPendingTransmission: transmitting %i @ %s\n", CpmModelC$transmitting[sim_node()], sim_time_string());
}
...
#line 243
        TossimPacketModelC$sending[sim_node()] = (void *)0;
        sim_log_debug(59U, "TossimPacketModelC", "PACKET: Failed to send packet due to busy channel.\n");
...
#line 194
  ...
  backoff += sim_csma_init_low();
  backoff *= sim_ticks_per_sec() / sim_csma_symbols_per_sec();
  sim_log_debug(58U, "TossimPacketModelC", "Starting CMSA with %lli.\n", backoff);
...
#line 161
{
  if (!TossimPacketModelC$initialized[sim_node()]) {
      sim_log_error(56U, "TossimPacketModelC", "TossimPacketModelC: Send.send() called, but not initialized!\n");
      return EOFF;
    }
  if (!TossimPacketModelC$running[sim_node()]) {
      sim_log_error(57U, "TossimPacketModelC", "TossimPacketModelC: Send.send() called, but not running!\n");
      return EOFF;
    }
...
#line 53
{
  return /*antAppC.SendQueueP*/QueueC$0$size[sim_node()] == 0;
}
...
#line 239
  sim_log_debug(69U, "CpmModelC,SNR", "SNR is %lf, PRR is %lf\n", SNR, prr_hat);
  if (prr_hat > 1) {
    prr_hat = 1.1;
    }
  else {
...
#line 129
  if (__nesc_ntoh_uint16(header->dest.nxdata) == TossimActiveMessageC$amAddress()) {
      sim_log_debug(49U, "Acks", "Received packet addressed to me so ack it\n");
      return TRUE;
    }
  return FALSE;
}
...
#line 299
      ...
      if (msg != TossimPacketModelC$sending[sim_node()]) {
          ...
          sim_log_debug(63U, "TossimPacketModelC", "Requested ack for 0x%x, but outgoing packet is 0x%x.\n", msg, TossimPacketModelC$sending[sim_node()]);
        }
    }
}
...
#line 157
  sim_log_debug(66U, "CpmModelC,SNRLoss", "SNR is %lf, ARR is %lf\n", SNR, prr_hat);
  if (prr_hat > 1) {
    prr_hat = 1.1;
    }
  else {
...
#line 86
{
  sim_log_debug(51U, "TossimPacketModelC", "TossimPacketModelC: Init.init() called\n");
...
#line 101
    {
      if (antC$battery[sim_node()] >= 9000) 
        {
          if (antC$battery_level[sim_node()] != 10) 
            {
              antC$battery_level[sim_node()] = 10;
              {
                  ...
                  if (antC$battery[sim_node()] < 4000 && antC$battery[sim_node()] >= 3000) 
                    {
                      if (antC$battery_level[sim_node()] != 4) 
                        {
                          if (antC$isrunning[sim_node()] == TRUE) 
                            {
...
#line 478
  ...
  new_packet->classify = 1;
  if (antC$SendQueue$enqueue(new_packet) == SUCCESS) 
    {
      if (antC$senddatatask$postTask() != SUCCESS) 
        {
...
#line 97
{
  if (/*antAppC.SendQueueP*/QueueC$0$Queue$size() < /*antAppC.SendQueueP*/QueueC$0$Queue$maxSize()) {
      sim_log_debug(225U, "QueueC", "%s: size is %hhu\n", __FUNCTION__, /*antAppC.SendQueueP*/QueueC$0$size[sim_node()]);
      /*antAppC.SendQueueP*/QueueC$0$queue[sim_node()][/*antAppC.SendQueueP*/QueueC$0$tail[sim_node()]] = newVal;
      /*antAppC.SendQueueP*/QueueC$0$tail[sim_node()]++;
      if (/*antAppC.SendQueueP*/QueueC$0$tail[sim_node()] == 20) {
#line 102
        /*antAppC.SendQueueP*/QueueC$0$tail[sim_node()] = 0;
        }
#line 103
      /*antAppC.SendQueueP*/QueueC$0$size[sim_node()]++;
      /*antAppC.SendQueueP*/QueueC$0$printQueue();
      return SUCCESS;
    }
  else {
      return FAIL;
...
#line 72
  ...
  for (i = /*antAppC.SendQueueP*/QueueC$0$head[sim_node()]; i < /*antAppC.SendQueueP*/QueueC$0$head[sim_node()] + /*antAppC.SendQueueP*/QueueC$0$size[sim_node()]; i++) {
      sim_log_debug_clear(220U, "QueueC", "[");
      for (j = 0; j < sizeof(/*antAppC.SendQueueP*/QueueC$0$queue_t ); j++) {
          uint8_t v = ((uint8_t *)&/*antAppC.SendQueueP*/QueueC$0$queue[sim_node()][i % 20])[j];
...
#line 72
  ...
  for (i = /*antAppC.ReceiveQueueP*/QueueC$1$head[sim_node()]; i < /*antAppC.ReceiveQueueP*/QueueC$1$head[sim_node()] + /*antAppC.ReceiveQueueP*/QueueC$1$size[sim_node()]; i++) {
      sim_log_debug_clear(227U, "QueueC", "[");
      for (j = 0; j < sizeof(/*antAppC.ReceiveQueueP*/QueueC$1$queue_t ); j++) {
          uint8_t v = ((uint8_t *)&/*antAppC.ReceiveQueueP*/QueueC$1$queue[sim_node()][i % 20])[j];
...
#line 85
{
  /*antAppC.ReceiveQueueP*/QueueC$1$queue_t t = /*antAppC.ReceiveQueueP*/QueueC$1$Queue$head();

#line 87
  sim_log_debug(231U, "QueueC", "%s: size is %hhu\n", __FUNCTION__, /*antAppC.ReceiveQueueP*/QueueC$1$size[sim_node()]);
  if (!/*antAppC.ReceiveQueueP*/QueueC$1$Queue$empty()) {
      /*antAppC.ReceiveQueueP*/QueueC$1$head[sim_node()]++;
      if (/*antAppC.ReceiveQueueP*/QueueC$1$head[sim_node()] == 20) {
#line 90
        /*antAppC.ReceiveQueueP*/QueueC$1$head[sim_node()] = 0;
        }
#line 91
      /*antAppC.ReceiveQueueP*/QueueC$1$size[sim_node()]--;
      /*antAppC.ReceiveQueueP*/QueueC$1$printQueue();
...
#line 55
{
  /*antAppC.SendControl.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(msg, dest);
  /*antAppC.SendControl.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(msg, 6);
  return /*antAppC.SendControl.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(msg, len);
}
...
#line 78
  sim_log_debug(46U, "AM", "AM: Sending packet (id=%hhu, len=%hhu) to %hu\n", id, len, addr);
...
#line 126
{
  ...
  sim_log_debug(64U, "CpmModelC", "IN: noise_hash_generation()\n");
  ...
  sim_log_debug(65U, "CpmModelC,Tal", "%s: OUT: noise_hash_generation(): %lf\n", sim_time_string(), noise_val);
...
#line 868
  ...
  if (antC$flag[sim_node()] == 1) 
    {
      if (&antC$pkt[sim_node()] == msg) 
        {
          antC$SendQueue$dequeue();
          antC$battery[sim_node()] = antC$battery[sim_node()] - 5;
          if (antC$check_battery_change() != 1) 
...
#line 910
          ...
          if (antC$hellonum[sim_node()] < 5) 
            {
              antC$hellonum[sim_node()]++;
              antC$MilliTimer$startOneShot(250);
            }
        }
      else 
        {
...
#line 85
{
  /*antAppC.SendQueueP*/QueueC$0$queue_t t = /*antAppC.SendQueueP*/QueueC$0$Queue$head();

#line 87
  sim_log_debug(224U, "QueueC", "%s: size is %hhu\n", __FUNCTION__, /*antAppC.SendQueueP*/QueueC$0$size[sim_node()]);
  if (!/*antAppC.SendQueueP*/QueueC$0$Queue$empty()) {
      /*antAppC.SendQueueP*/QueueC$0$head[sim_node()]++;
      if (/*antAppC.SendQueueP*/QueueC$0$head[sim_node()] == 20) {
#line 90
        /*antAppC.SendQueueP*/QueueC$0$head[sim_node()] = 0;
        }
#line 91
      /*antAppC.SendQueueP*/QueueC$0$size[sim_node()]--;
      /*antAppC.SendQueueP*/QueueC$0$printQueue();
...
{
  if (!TossimPacketModelC$initialized[sim_node()]) {
      sim_log_error(52U, "TossimPacketModelC", "TossimPacketModelC: Control.start() called before initialization!\n");
      return FAIL;
    }
  sim_log_debug(53U, "TossimPacketModelC", "TossimPacketModelC: Control.start() called.\n");
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  /* Module antC */
  if (!strcmp(varname, "antC$routing_table"))
  {
    *addr = (uintptr_t)&antC$routing_table[__nesc_mote];
    *size = sizeof(antC$routing_table[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "antC$tableactive"))
  {
    *addr = (uintptr_t)&antC$tableactive[__nesc_mote];
    *size = sizeof(antC$tableactive[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "antC$battery"))
  {
    *addr = (uintptr_t)&antC$battery[__nesc_mote];
    *size = sizeof(antC$battery[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "antC$isrunning"))
  {
    *addr = (uintptr_t)&antC$isrunning[__nesc_mote];
    *size = sizeof(antC$isrunning[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "antC$busy"))
  {
    *addr = (uintptr_t)&antC$busy[__nesc_mote];
    *size = sizeof(antC$busy[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "antC$pkt"))
  {
    *addr = (uintptr_t)&antC$pkt[__nesc_mote];
    *size = sizeof(antC$pkt[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "antC$pkt2"))
  {
    *addr = (uintptr_t)&antC$pkt2[__nesc_mote];
    *size = sizeof(antC$pkt2[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "antC$pkt3"))
  {
    *addr = (uintptr_t)&antC$pkt3[__nesc_mote];
    *size = sizeof(antC$pkt3[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "antC$hellonum"))
  {
    *addr = (uintptr_t)&antC$hellonum[__nesc_mote];
    *size = sizeof(antC$hellonum[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "antC$forward_num"))
  {
    *addr = (uintptr_t)&antC$forward_num[__nesc_mote];
    *size = sizeof(antC$forward_num[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "antC$backward_num"))
  {
    *addr = (uintptr_t)&antC$backward_num[__nesc_mote];
    *size = sizeof(antC$backward_num[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "antC$post_fail"))
  {
    *addr = (uintptr_t)&antC$post_fail[__nesc_mote];
    *size = sizeof(antC$post_fail[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "antC$flag"))
  {
    *addr = (uintptr_t)&antC$flag[__nesc_mote];
    *size = sizeof(antC$flag[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "antC$receiveantnum"))
  {
    *addr = (uintptr_t)&antC$receiveantnum[__nesc_mote];
    *size = sizeof(antC$receiveantnum[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "antC$sendnum"))
  {
    *addr = (uintptr_t)&antC$sendnum[__nesc_mote];
    *size = sizeof(antC$sendnum[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "antC$testnum"))
  {
    *addr = (uintptr_t)&antC$testnum[__nesc_mote];
    *size = sizeof(antC$testnum[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "antC$battery_level"))
  {
    *addr = (uintptr_t)&antC$battery_level[__nesc_mote];
    *size = sizeof(antC$battery_level[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "antC$receiving"))
  {
    *addr = (uintptr_t)&antC$receiving[__nesc_mote];
    *size = sizeof(antC$receiving[__nesc_mote]);
    return 0;
  }
  ...
  /* Module QueueC$0 */
  if (!strcmp(varname, "/*antAppC.SendQueueP*/QueueC$0$queue"))
  {
    *addr = (uintptr_t)&/*antAppC.SendQueueP*/QueueC$0$queue[__nesc_mote];
    *size = sizeof(/*antAppC.SendQueueP*/QueueC$0$queue[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*antAppC.SendQueueP*/QueueC$0$head"))
  {
    *addr = (uintptr_t)&/*antAppC.SendQueueP*/QueueC$0$head[__nesc_mote];
    *size = sizeof(/*antAppC.SendQueueP*/QueueC$0$head[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*antAppC.SendQueueP*/QueueC$0$tail"))
  {
    *addr = (uintptr_t)&/*antAppC.SendQueueP*/QueueC$0$tail[__nesc_mote];
    *size = sizeof(/*antAppC.SendQueueP*/QueueC$0$tail[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*antAppC.SendQueueP*/QueueC$0$size"))
  {
    *addr = (uintptr_t)&/*antAppC.SendQueueP*/QueueC$0$size[__nesc_mote];
    *size = sizeof(/*antAppC.SendQueueP*/QueueC$0$size[__nesc_mote]);
    return 0;
  }

  /* Module QueueC$1 */
  if (!strcmp(varname, "/*antAppC.ReceiveQueueP*/QueueC$1$queue"))
  {
    *addr = (uintptr_t)&/*antAppC.ReceiveQueueP*/QueueC$1$queue[__nesc_mote];
    *size = sizeof(/*antAppC.ReceiveQueueP*/QueueC$1$queue[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*antAppC.ReceiveQueueP*/QueueC$1$head"))
  {
    *addr = (uintptr_t)&/*antAppC.ReceiveQueueP*/QueueC$1$head[__nesc_mote];
    *size = sizeof(/*antAppC.ReceiveQueueP*/QueueC$1$head[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*antAppC.ReceiveQueueP*/QueueC$1$tail"))
  {
    *addr = (uintptr_t)&/*antAppC.ReceiveQueueP*/QueueC$1$tail[__nesc_mote];
    *size = sizeof(/*antAppC.ReceiveQueueP*/QueueC$1$tail[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*antAppC.ReceiveQueueP*/QueueC$1$size"))
  {
    *addr = (uintptr_t)&/*antAppC.ReceiveQueueP*/QueueC$1$size[__nesc_mote];
    *size = sizeof(/*antAppC.ReceiveQueueP*/QueueC$1$size[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  /* Module antC */
  memset((void *)&antC$routing_table[__nesc_mote], 0, sizeof antC$routing_table[__nesc_mote]);
  memset((void *)&antC$tableactive[__nesc_mote], 0, sizeof antC$tableactive[__nesc_mote]);
  memset((void *)&antC$battery[__nesc_mote], 0, sizeof antC$battery[__nesc_mote]);
  memset((void *)&antC$isrunning[__nesc_mote], 0, sizeof antC$isrunning[__nesc_mote]);
  antC$busy[__nesc_mote] = FALSE;
  memset((void *)&antC$pkt[__nesc_mote], 0, sizeof antC$pkt[__nesc_mote]);
  memset((void *)&antC$pkt2[__nesc_mote], 0, sizeof antC$pkt2[__nesc_mote]);
  memset((void *)&antC$pkt3[__nesc_mote], 0, sizeof antC$pkt3[__nesc_mote]);
  memset((void *)&antC$hellonum[__nesc_mote], 0, sizeof antC$hellonum[__nesc_mote]);
  antC$forward_num[__nesc_mote] = 0;
  antC$backward_num[__nesc_mote] = 0;
  memset((void *)&antC$post_fail[__nesc_mote], 0, sizeof antC$post_fail[__nesc_mote]);
  memset((void *)&antC$flag[__nesc_mote], 0, sizeof antC$flag[__nesc_mote]);
  memset((void *)&antC$receiveantnum[__nesc_mote], 0, sizeof antC$receiveantnum[__nesc_mote]);
  memset((void *)&antC$sendnum[__nesc_mote], 0, sizeof antC$sendnum[__nesc_mote]);
  memset((void *)&antC$testnum[__nesc_mote], 0, sizeof antC$testnum[__nesc_mote]);
  memset((void *)&antC$battery_level[__nesc_mote], 0, sizeof antC$battery_level[__nesc_mote]);
  memset((void *)&antC$receiving[__nesc_mote], 0, sizeof antC$receiving[__nesc_mote]);
  ...
  /* Module QueueC$0 */
  memset((void *)&/*antAppC.SendQueueP*/QueueC$0$queue[__nesc_mote], 0, sizeof /*antAppC.SendQueueP*/QueueC$0$queue[__nesc_mote]);
  /*antAppC.SendQueueP*/QueueC$0$head[__nesc_mote] = 0;
  /*antAppC.SendQueueP*/QueueC$0$tail[__nesc_mote] = 0;
  /*antAppC.SendQueueP*/QueueC$0$size[__nesc_mote] = 0;

  /* Module QueueC$1 */
  memset((void *)&/*antAppC.ReceiveQueueP*/QueueC$1$queue[__nesc_mote], 0, sizeof /*antAppC.ReceiveQueueP*/QueueC$1$queue[__nesc_mote]);
  /*antAppC.ReceiveQueueP*/QueueC$1$head[__nesc_mote] = 0;
  /*antAppC.ReceiveQueueP*/QueueC$1$tail[__nesc_mote] = 0;
  /*antAppC.ReceiveQueueP*/QueueC$1$size[__nesc_mote] = 0;
